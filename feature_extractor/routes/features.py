...
from feature_extractor.schemas import ExtractFeaturesRequest, ExtractFeaturesResponse
...
async def extract_features(
    request: Annotated[ExtractFeaturesRequest, Query()],
    ...
    try:
        return await extract_features_from_image(prepared, file.filename, file.content_type, request, extractor)
